...
def SignupPage(request):
    if request.method == 'POST':
        ...
        message = render_to_string('verification_email.html', {'username': username, 'verification_link': verification_link})
        send_mail(subject, message, 'autodialer23@gmail.com', [email], fail_silently=False, html_message=message)
